// HarmonyAnalysis.js - Roman numeral analysis for SATB part-writing checking
...
function getChordData(rn, tonicTPC, mode) {
    ...
    var parts = rn.split('/');
    var primaryPart = parts[0].replace("Ã¸", "0");
    var targetPart = parts.length > 1 ? parts[1].replace("Ã¸", "0") : null;
